    ...
    return (
      <main className="flex min-h-screen items-center justify-center px-5 py-10">
        <div className="max-w-[420px] text-center" data-fade>
          <div className="mb-4 inline-flex items-center gap-2 text-[11px] font-bold uppercase tracking-[.08em] text-slate-400">
            <span className="inline-flex h-[18px] w-[18px] items-center justify-center rounded-[5px] bg-slate-300 text-[11px] text-white">
              S
            </span>
            Seoul Medical Group
          </div>
          <h1 className="mb-2 text-xl font-semibold text-ink">This link is no longer active</h1>
  ...
  return (
    <main className="mx-auto w-full max-w-[1060px] px-6 pb-16 pt-8" data-fade>
      <div className="mb-6 text-center">
        <div className="mb-2.5 inline-flex items-center gap-2 text-[11px] font-bold uppercase tracking-[.08em] text-accent">
          <span className="inline-flex h-[18px] w-[18px] items-center justify-center rounded-[5px] bg-accent text-[11px] text-white">
            S
          </span>
          Seoul Medical Group
        </div>
        <h1 className="mb-1.5 text-[22px] font-semibold text-ink">A few quick facts</h1>
        <p className="mx-auto max-w-[440px] text-[13.5px] leading-[1.5] text-slate-500">
          Your broker will use these to find Medicare Advantage plans that fit you. Required items are marked
          with <span className="text-rose-600">*</span> — everything else is optional.
        </p>
      </div>
